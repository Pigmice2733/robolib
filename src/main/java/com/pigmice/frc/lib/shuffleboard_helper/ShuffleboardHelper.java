...
public class ShuffleboardHelper {
  ...
  public static class ShuffleboardInput extends ShuffleboardObject {
    ...
    @Override
    public void update() {
      consumer.accept(entry.get().getValue());
    }
   ...
   *
   * @param name     the name of the Shuffleboard item
   * @param tab      the Shuffleboard tab on which to display the item
   * @param supplier function that returns a value to output to Shuffleboard
   *
   */
  ...
  /**
   * Add a new input field to Shuffleboard that will automatically update the
   * code.
   * 
   * @param name     the name of the Shuffleboard item
   * @param tab      the Shuffleboard tab on which to display the item
   * @param consumer function that uses the value from Shuffleboard
   */
  ...
  public static ShuffleboardLayout addMotorInfo(String name, ShuffleboardTab tab, CANSparkMax motor) {
    ShuffleboardLayout layout = tab.getLayout(name, BuiltInLayouts.kList).withSize(2, 3);
