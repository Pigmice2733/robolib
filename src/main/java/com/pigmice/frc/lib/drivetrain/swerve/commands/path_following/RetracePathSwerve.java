...
// points.add(new PathPoint(current.getTranslation(), angleToNext,
// current.getRotation()));
// }
...
// PathPlanner.generatePath(drivetrain.config.PATH_CONSTRAINTS, points);
// CommandScheduler.getInstance().schedule(new FollowPathSwerve(drivetrain,
// trajectory));
// }
