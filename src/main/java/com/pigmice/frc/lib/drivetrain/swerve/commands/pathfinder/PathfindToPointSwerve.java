...
// */
// public PathfindToPointSwerve(SwerveDrivetrain drivetrain, Pathfinder
// pathfinder, Pose2d goalPose) {
...
// pathfinder.findPath(drivetrain.getPose().getTranslation(),
...
// return;
// }
// pathCommand = new FollowPathSwerve(drivetrain,
// result.getAsTrajectory(drivetrain.config.PATH_CONSTRAINTS));
